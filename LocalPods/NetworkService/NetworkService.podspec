...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Oleg Sinev/NetworkService'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Oleg Sinev' => 'raikonen@me.com' }
  s.source           = { :git => 'https://github.com/Oleg Sinev/NetworkService.git', :tag => s.version.to_s }
